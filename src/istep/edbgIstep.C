...
//number| number|                                       |                                   |
  ...
  { 0,   6,                             "updatehwmodel",                   EDBG_ISTEP_NOOP},
  ...
  { 1,  11,                   "ph_sppe_check_for_ready",                   EDBG_ISTEP_NOOP},
  { 1,  12,                            "ph_sppe_update",                   EDBG_ISTEP_NOOP},
  { 1,  13,                        "ph_sppe_attr_setup",                   EDBG_ISTEP_SBE},
  { 1,  14,                     "ph_sppe_attr_override",                   EDBG_ISTEP_NOOP},
  { 1,  15,                              "ph_rcs_setup",                   EDBG_ISTEP_NOOP},
  { 1,  16,                          "ph_tp_repr_initf",                   EDBG_ISTEP_NOOP},
  { 1,  17,                           "ph_tp_arrayinit",                   EDBG_ISTEP_NOOP},
  { 1,  18,                   "ph_tp_arrayinit_cleanup",                   EDBG_ISTEP_NOOP},
  { 1,  19,                               "ph_tp_initf",                   EDBG_ISTEP_NOOP},
  { 1,  20,                         "ph_tp_startclocks",                   EDBG_ISTEP_NOOP},
  { 1,  21,                                "ph_tp_init",                   EDBG_ISTEP_NOOP},
  { 2,   1,                               "ph_fsi_init",                   EDBG_ISTEP_NOOP},
  ...
  { 2,   6,                     "pc_tp_arrayinit_start",                   EDBG_ISTEP_SBE},
  { 2,   7,                      "pc_tp_arrayinit_poll",                   EDBG_ISTEP_SBE},
  { 2,   8,                   "pc_tp_arrayinit_cleanup",                   EDBG_ISTEP_SBE},
  { 2,   9,                               "pc_tp_lbist",                   EDBG_ISTEP_SBE},
  { 2,  10,                        "pc_pib_startclocks",                   EDBG_ISTEP_SBE},
  { 2,  11,                   "ph_pc_sbe_load_code_pak",                   EDBG_ISTEP_SBE},
  { 2,  12,                   "ph_pc_sbe_load_cust_pak",                   EDBG_ISTEP_SBE},
  ...
  { 2,  18,                              "pc_pll_initf",                   EDBG_ISTEP_SBE},
  { 2,  19,                              "pc_pll_setup",                   EDBG_ISTEP_SBE},
  { 2,  20,                               "pc_tp_initf",                   EDBG_ISTEP_SBE},
  { 2,  21,                         "pc_tp_startclocks",                   EDBG_ISTEP_SBE},
  { 2,  22,                                "pc_tp_init",                   EDBG_ISTEP_SBE},
  ...
  { 3,  21,                  "proc_sbe_check_boot_proc",                   EDBG_ISTEP_SBE},
  ...
  { 4,  12,                       "proc_hcd_core_reset",                   EDBG_ISTEP_SBE},
  ...
  { 6,   7,                   "host_update_primary_tpm",                   EDBG_ISTEP_HOST},
  ...
  { 8,   1,                            "host_setup_sbe",                   EDBG_ISTEP_HOST},
  { 8,   2,                 "host_secondary_sbe_config",                   EDBG_ISTEP_HOST},
  { 8,   3,                            "host_cbs_start",                   EDBG_ISTEP_HOST},
  { 8,   4, "proc_check_secondary_sbe_seeprom_complete",                   EDBG_ISTEP_HOST},
  ...
  {12,   3,                         "proc_omi_scominit",                   EDBG_ISTEP_HOST},
