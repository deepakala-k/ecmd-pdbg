...
//number| number|                                       |                                   |
  ...
  { 1,  16,                          "ph_tp_repr_initf",                   EDBG_ISTEP_SBE},
  { 1,  17,                           "ph_tp_arrayinit",                   EDBG_ISTEP_SBE},
  { 1,  18,                   "ph_tp_arrayinit_cleanup",                   EDBG_ISTEP_SBE},
  { 1,  19,                               "ph_tp_initf",                   EDBG_ISTEP_SBE},
  { 1,  20,                         "ph_tp_startclocks",                   EDBG_ISTEP_SBE},
  { 1,  21,                                "ph_tp_init",                   EDBG_ISTEP_SBE},
